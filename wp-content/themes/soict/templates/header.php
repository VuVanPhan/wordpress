		...
		<div class="fusion-logo" data-margin-top="<?php echo intval( Avada()->settings->get( 'margin_logo_top' ) ); ?>px" data-margin-bottom="<?php echo intval( Avada()->settings->get( 'margin_logo_bottom' ) ); ?>px" data-margin-left="<?php echo intval( Avada()->settings->get( 'margin_logo_left' ) ); ?>px" data-margin-right="<?php echo intval( Avada()->settings->get( 'margin_logo_right' ) ); ?>px">
			...
			<?php if ( Avada()->settings->get( 'logo' ) ) : ?>
				<a class="fusion-logo-link" href="<?php echo home_url(); ?>">
					...
					<?php $logo_size['width']  = Avada()->settings->get( 'retina_logo_width' )? 'width:'.fusion_strip_unit( Avada()->settings->get( 'retina_logo_width' ) ).'px;':''; ?>
					<?php $logo_size['height'] = Avada()->settings->get( 'retina_logo_height' )? 'height:'.fusion_strip_unit( Avada()->settings->get( 'retina_logo_height' ) ).'px;':''; ?>

					<img src="<?php echo $logo_url; ?>" style="<?php echo $logo_size['width']; ?> <?php echo $logo_size['height']; ?>" alt="<?php bloginfo( 'name' ); ?>" class="fusion-logo-1x fusion-standard-logo" />
					...
					<?php if ( $retina_logo ) : ?>
						...
						<img src="<?php echo $retina_logo; ?>" style="<?php echo $logo_size['width']; ?> <?php echo $logo_size['height']; ?>" alt="<?php bloginfo('name'); ?>" <?php echo $style; ?> class="fusion-standard-logo fusion-logo-2x" />
					<?php else: ?>
						<img src="<?php echo $logo_url; ?>" style="<?php echo $logo_size['width']; ?> <?php echo $logo_size['height']; ?>" alt="<?php bloginfo('name'); ?>" class="fusion-standard-logo fusion-logo-2x" />
					<?php endif; ?>
