...
<div class="eightcol column">
	...
	<form class="ajax-form formatted-form" action="<?php echo AJAX_URL; ?>" method="POST">
		...
		<div class="sixcol column last">
			<div class="field-wrapper">
				<input type="text" name="user_phone" placeholder="<?php _e('Phone','academy'); ?>" />
			</div>
		</div>
		<div class="clear"></div>
		<div class="sixcol column">
			<div class="field-wrapper">
				<input type="radio" value="1" name="user_type" placeholder="<?php _e('Business','academy'); ?>" /><?php _e('Business','academy'); ?>
			</div>
		</div>
		<div class="sixcol column last">
			<div class="field-wrapper">
				<input type="radio" value="2" name="user_type" placeholder="<?php _e('Student','academy'); ?>" /><?php _e('Student','academy'); ?>
			</div>
		</div>
		<div class="clear"></div>
