...
$config = array (
	...
	'components' => array(
		...
		'rewrite_rules' => array (
			...
			//Michael edit
			'university-internship' => array(
				'title' => __('Internship', 'academy'),
				'name' => 'university-internship',
				'rule' => 'university-internship/?',
				'rewrite' => 'index.php?university-internship=1',
				'position' => 'top',
				'private' => true,
			),
            ...
            'internship-cv' => array(
                'title' => __('Internship CV', 'academy'),
                'name' => 'internship-cv',
                'rule' => 'internship-cv/?',
                'rewrite' => 'index.php?internship-cv=1',
                'position' => 'top',
                'private' => true,
            ),

            'register-internship' => array(
                'title' => __('Register Internship', 'academy'),
                'name' => 'register-internship',
                'rule' => 'register-internship/?',
                'rewrite' => 'index.php?register-internship=1',
                'position' => 'top',
                'private' => true,
            ),

            'internship-information' => array(
                'title' => __('Internship Information', 'academy'),
                'name' => 'internship-information',
                'rule' => 'internship-information/?',
                'rewrite' => 'index.php?internship-information=1',
                'position' => 'top',
                'private' => true,
            ),

            'internship-result' => array(
                'title' => __('Internship Result', 'academy'),
                'name' => 'internship-result',
                'rule' => 'internship-result/?',
                'rewrite' => 'index.php?internship-result=1',
                'position' => 'top',
                'private' => true,
            ),

            'internship-report' => array(
                'title' => __('Internship Report', 'academy'),
                'name' => 'internship-report',
                'rule' => 'internship-report/?',
                'rewrite' => 'index.php?internship-report=1',
                'position' => 'top',
                'private' => true,
            ),
            ...
            'university-edit-program' => array(
				'title' => __('Edit program', 'academy'),
				'name' => 'university-edit-program',
				'rule' => 'university-edit-program/?',
				'rewrite' => 'index.php?university-edit-program=1',
				'position' => 'top',
				'private' => true,
			),

			'view-university' => array(
				'title' => __('View university', 'academy'),
				'name' => 'view-university',
				'rule' => 'view-university/?',
				'rewrite' => 'index.php?view-university=1',
				'position' => 'top',
				'private' => true,
			),

			'view-company' => array(
				'title' => __('View company', 'academy'),
				'name' => 'view-company',
				'rule' => 'view-company/?',
				'rewrite' => 'index.php?view-company=1',
				'position' => 'top',
				'private' => true,
			),

			'view-company-popup' => array(
				'title' => __('View company', 'academy'),
				'name' => 'view-company-popup',
				'rule' => 'view-company-popup/?',
				'rewrite' => 'index.php?view-company-popup=1',
				'position' => 'top',
				'private' => true,
			),

			'view-university-popup' => array(
				'title' => __('View university', 'academy'),
				'name' => 'view-university-popup',
				'rule' => 'view-university-popup/?',
				'rewrite' => 'index.php?view-university-popup=1',
				'position' => 'top',
				'private' => true,
			),
