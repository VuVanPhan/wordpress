...
$grid_url = get_admin_url() . '-assign-company';
$url_company = get_admin_url() . 'admin.php?page=soict-company';

?>
<div class="wrap about-wrap avada-wrap">
    <h3><?php echo __("Assign company to internship \"".$internship->getTitle().'"', "Soict"); ?></h3>
    ...
    <div class="feature-section">
        ...
        <h4>
            ...
            <!--&nbsp;&nbsp;&nbsp;-->
            <a href="<?php echo $url ?>-assigned-company&id=<?php echo $internship->getId() ?>" class="page-title-action">&lt;&lt;<?php echo __("Back", "Soict") ?></a>
        </h4>

        <form action="<?php echo $url ?>-assign-company" method="get">
            <input type="hidden" name="page" value="soict-internship-assign-company"/>
            <input type="hidden" name="id" value="<?php echo $internship->getId() ?>"/>

            <p class="search-box">
                <a href="<?php echo $url ?>-assign-company&reset=1" class="button" title="reset" rel="nofollow"><?php echo __('Reset Filter', 'Soict') ?></a>
            </p>
            <p class="search-box">
            ...
            <div class="tablenav top">
                ...
                <div class="alignleft actions">
                    ...
                    <label for="student_qty" ><?php echo __('Student qty', 'Soict') ?>:</label>
                    <input type="text" id="student_qty" name="student_qty" value="15" size="1" title="<?php echo __('Student assign number of qty', 'Soict') ?>"/>
            ...
            <table class="wp-list-table widefat fixed striped">
                ...
                <tr>
                    ...
                    <?php echo $this->sorted('name') ?>">
                        <a href="<?php echo $url ?>-assign-company&orderby=name&order=<?php echo ($order == 'desc') ? 'asc' : 'desc' ?>">
