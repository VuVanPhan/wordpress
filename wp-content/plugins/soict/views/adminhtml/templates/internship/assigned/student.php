...
$grid_url = $url . '-assigned-student';
$url_student = get_admin_url() . 'admin.php?page=soict-student';

?>
<div class="wrap about-wrap avada-wrap">
    <h3><?php echo __("Students in internship \"".$internship->getTitle().'"', "Soict"); ?></h3>
    ...
    <div class="feature-section">
        ...
        <h4>
            ...
            &nbsp;&nbsp;&nbsp;
            <a href="<?php echo $url ?>-assign-student&id=<?php echo $internship->getId() ?>" class="page-title-action"><?php echo __("Assign Student", "Soict") ?></a>
        </h4>

        <form action="<?php echo $grid_url ?>" method="get">
            <input type="hidden" name="page" value="soict-internship-assigned-student"/>
