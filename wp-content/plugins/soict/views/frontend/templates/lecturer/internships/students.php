...
$grid_url = get_site_url('', 'lecturer/internships/students');
?>
...
<div class="internship list-wrap">
    ...
    <div class="row-header">
        <h3><?php echo __('Danh sách các sinh viên đã đăng ký thực tập') ?></h3>
            ...
            <table class="soict-table">
                ...
                <?php foreach($collection as $item): ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($item->getLecturerReviewText() || $item->getLecturerReviewFile())
                                ? $item->getLecturerPoints() : '--' ?></td>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <span class="fade-text registered"><?php echo __('SV chưa nộp báo cáo') ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php $count++; ?>
