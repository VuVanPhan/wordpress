...
$grid_url = get_site_url('', 'company/my-internships');
?>
<?php if (\SoictApp::getView('notices.php')) include \SoictApp::getView('notices.php'); ?>
<div class="internship list-wrap">
    <div class="row-header"><h3><?php echo __('Danh sách các chương trình thực tập đã đăng ký') ?></h3></div>
            ...
            <table class="soict-table">
                ...
                <?php foreach($collection as $item): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo $grid_url ?>/students?internship=<?php echo $item->getId() ?>"><?php echo $item->getTitle() ?></a></td>
