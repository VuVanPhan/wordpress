...
namespace Soict\Controller\Lecturer\Internships;
...
class Students extends ControllerFrontend {
	...
	public function execute(){
		$this->setTemplate('lecturer/internships/students.php');
	...
	public function getCollection(){
		...
		if(!$this->_collection){
			...
			$groups->getSelect()
				->where('lecturer_id', \SoictApp::helper('user')->getCurrentUser()->getId())
